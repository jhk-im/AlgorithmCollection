...
fun main(args: Array<String>) {
    ...
    print(Solution().solution(players, callings))
}
...
class Solution {
    fun solution(players: Array<String>, callings: Array<String>): Array<String> {
        ...
        var count = 0
        val callHashMap = callings.associateBy({count++}, {it})
        for (call in callHashMap.values) {
            val callIndex = playerList.indexOf(call)
            Collections.swap(playerList, callIndex, callIndex - 1)
        }
