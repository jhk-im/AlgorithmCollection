...
처음에 3, 4, 5, 6번 영역에 페인트칠을 하면 칠해야 할 곳으로 2번 구역만 남고 
1, 2, 3, 4번 구역에 페인트칠을 하면 2번 만에 다시 칠해야 할 곳에 모두 페인트칠을 할 수 있습니다.
*/
fun main(args: Array<String>) {
    val n = 8 // 벽의 길이
    val m = 4 // 롤러의 길이
    val section = intArrayOf(2,3,6) // 칠해야 하는 곳
    print(Solution().solution(n, m, section))
}
